...
using matrix = emblib::math::matrix<scalar_type, ROWS, COLS>;
...
template <
    ...
    typename Base
>
struct type_caster<emblib::math::matrix<Scalar, Rows, Cols, Base> > {
    using wrapper_type = emblib::math::matrix<Scalar, Rows, Cols, Base>;
